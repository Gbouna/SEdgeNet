...
def parse_arguments():
    ...
    parser.add_argument('--k', type=int, default=35, help='Number of nearest neighbors (k) for graph construction')
    ...
    parser.add_argument('--num_layers', type=int, default=2, help='Number of standard conv layers to use')
    parser.add_argument('--sample_ratio', type=float, default=0.3, help='fraction of neighbors to keep when sampling (0 < sample_ratio <= 1)')
...
if __name__ == "__main__":
    ...
    if not args.eval:
        ...
        for run_num in range(1, args.num_runs + 1):
            ...
            # Create a new IOStream for test logging (or reuse the training one)
